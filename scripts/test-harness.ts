/* eslint-disable functional/functional-parameters, functional/no-throw-statements, @typescript-eslint/no-unsafe-assignment, @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-unsafe-argument */
