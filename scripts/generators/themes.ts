...
export const ECHARTS_PRODUCTS = ['Matcha Latte', 'Milk Tea', 'Cheese Cocoa', 'Walnut Brownie'];
export const BROWSERS = ['Chrome', 'Firefox', 'Safari', 'Edge', 'Opera'];
export const TRAFFIC_SOURCES = ['Search Engine', 'Direct', 'Email', 'Union Ads', 'Video Ads'];
...
export function themeSubset(theme: string[], minLength = 3) {
	return fc.subarray(theme, { minLength, maxLength: theme.length });
}
