...
import { transformDataToChartOption, SankeyTransformerOptions } from '../src/charts/transformer';
import { SankeySeriesOption } from 'echarts';

describe('Sankey Transformer', () => {
    it('should transform data to sankey series', () => {
        const data = [
    ...
    it('should handle missing values with default 1', () => {
        const data = [
