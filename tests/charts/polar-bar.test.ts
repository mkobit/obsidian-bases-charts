...
describe('Polar Bar Chart Transformer', () => {
	...
	it('should create basic polar bar chart', () => {
		const option = createPolarBarChartOption(data, 'angle', 'radius');
...
radius: 'y' });
	...
	it('should handle series grouping', () => {
		const option = createPolarBarChartOption(data, 'angle', 'radius', { seriesProp: 'series' });
