...
describe('createLinesChartOption', () => {
    const data = [
        { startX: 10, startY: 10, endX: 20, endY: 20, group: 'A' },
        { startX: 30, startY: 30, endX: 40, endY: 40, group: 'A' },
        { startX: 100, startY: 100, endX: 110, endY: 110, group: 'B' },
    ];

    it('should create lines chart options', () => {
        const option = createLinesChartOption(data, 'startX', 'startY', {
            x2Prop: 'endX',
            y2Prop: 'endY',
            seriesProp: 'group'
        });
