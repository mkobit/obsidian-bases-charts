...
describe('createEffectScatterChartOption', () => {
    const data = [
        { category: 'A', value: 10, series: 'S1', size: 5 },
        { category: 'B', value: 20, series: 'S1', size: 10 },
        { category: 'A', value: 15, series: 'S2', size: 15 },
        { category: 'B', value: 25, series: 'S2', size: 20 },
    ];

    it('should create basic effect scatter chart options', () => {
        const option = createEffectScatterChartOption(data, 'category', 'value', {
            seriesProp: 'series'
        });
    ...
    it('should handle size property', () => {
        ...
        const point = { x: 'A', y: 10, s: 'S1', size: 30 };
