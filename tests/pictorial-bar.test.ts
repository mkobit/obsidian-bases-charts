...
describe('createPictorialBarChartOption', () => {
    const data = [
        { category: 'A', value: 10 },
        { category: 'B', value: 20 },
        { category: 'C', value: 30 }
    ...
    it('should create a basic pictorial bar chart option', () => {
        const option = createPictorialBarChartOption(data, 'category', 'value');
    ...
    it('should configure symbol options', () => {
        const option = createPictorialBarChartOption(data, 'category', 'value', {
            symbol: 'rect',
            symbolRepeat: true,
            symbolClip: true,
    ...
    it('should handle string booleans for symbolRepeat', () => {
        ...
        // Test "fixed" string
        const optionFixed = createPictorialBarChartOption(data, 'category', 'value', {
            symbolRepeat: 'fixed'
        });
    ...
    it('should handle series grouping', () => {
        ...
        const option = createPictorialBarChartOption(groupData, 'category', 'value', {
            seriesProp: 'group'
        });
