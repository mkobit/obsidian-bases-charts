...
describe('createPolarScatterChartOption', () => {
	...
	it('should create a basic polar scatter chart', () => {
		const option = createPolarScatterChartOption(data, 'angle', 'radius');
	...
	it('should handle size property and visual map', () => {
		const option = createPolarScatterChartOption(data, 'angle', 'radius', {
			sizeProp: 'size',
		});
