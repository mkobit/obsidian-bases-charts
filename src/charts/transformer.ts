...
} from './transformers/custom'
import {
  createCustomChartOption,
} from './transformers/custom'
...
>> = {
  ...
  custom: (data, xProp, yProp, options): EChartsOption => createCustomChartOption(
    data,
    xProp,
    yProp,
    asOptions(options),
...
export { type CustomTransformerOptions } from './transformers/custom'
